# -*- coding: utf-8 -*-
"""
Created on Tue Jan  7 19:09:45 2020

@author: iain
"""

# =============================================================================
# Using to measure independent sample T-test and report the statistics in a text file
# =============================================================================
import os
import pandas as pd
...
file = path.name
df = pd.read_csv(file)
output = file.strip('.csv') + '_independent_ttest_statistics_results.txt'
...
# =============================================================================
t_sv, t_pv = stats.ttest_ind(ctrl_data[dep_var], var_data[dep_var])
t_sv = abs(t_sv)
